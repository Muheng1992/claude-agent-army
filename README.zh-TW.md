...
### 實際案例：從零建構一個完整的 full-stack monorepo

![Mission Complete — 93 個檔案、6102 行程式碼、47 個測試、12 個 agent](./docs/images/mission-complete.png)

<details>
<summary>查看完整建構過程（點擊展開）</summary>

**任務規劃 — 自動拆解為 5 個執行 wave：**
...
**Wave 3 — Tester + Reviewer 同時運行，自動修復 critical issues：**
